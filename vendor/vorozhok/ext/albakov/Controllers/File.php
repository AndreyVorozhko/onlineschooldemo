...
namespace ext\albakov\Controllers;
...
class File
{
    ...
    public function isImage()
    {
        try {
			...
			*/
            return in_array($this->exif_image_type($this->getFullPathToFile()), [IMAGETYPE_GIF, IMAGETYPE_JPEG, IMAGETYPE_PNG, IMAGETYPE_BMP]);
        } catch (\Exception $e) {
            return false;
        }
    }
	
	private function exif_image_type($filename){
		if(function_exists('exif_imagetype')){
