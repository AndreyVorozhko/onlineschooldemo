...
;(function ( $, window, undefined ) {
  ...
  Pep.prototype.init = function () {
	...
	//UpperBigger by Vorozhok
	if ( this.options.upperBigger ){
		this.upperBigger();
	}
  ...
  //Added by vorozhok
  Pep.prototype.upperBigger = function() {
    this.$el.css(
		{
			zIndex:     Math.abs($('#container').outerWidth() - Math.max(this.$el.outerWidth(),this.$el.outerHeight()))|0 + 2
		}
	);
  };
