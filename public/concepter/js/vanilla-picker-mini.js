...
var Picker = (function() {
    ...
    function Picker(options) {
		...
		/*
		localStorage.setItem('lastz', this.settings.parent.parentElement.style.zIndex);
		this.settings.parent.parentElement.style.zIndex = 2000;
		console.log("init " + this.settings.parent.parentElement.id + " z = " + localStorage.getItem('lastz'));
		*/
    }
    ...
    pp._toggleDOM = function(toVisible) {
		...
		/*
		var lastz = localStorage.getItem('lastz');
		if(toVisible){
			if(dom.parentElement.parentElement.style.zIndex != 2000){
				localStorage.setItem('lastz', dom.parentElement.parentElement.style.zIndex);
				dom.parentElement.parentElement.style.zIndex = 2000;
				console.log("open " + dom.parentElement.parentElement.id + " z = " + localStorage.getItem('lastz'));
			}
		}else{
				if(dom.parentElement.parentElement.style.zIndex == 2000){
				dom.parentElement.parentElement.style.zIndex = lastz;
				//console.log(dom.parentElement.parentElement.style.zIndex);
				console.log("close " + dom.parentElement.parentElement.id + " z = " + localStorage.getItem('lastz'));
				}
		}
		*/
        return toggle;
