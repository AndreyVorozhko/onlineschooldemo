...
(function ($) {
	...
	Popover.prototype.close = function () {
		var _this = this,
			_closesel = this.opts.closeSelector;
			
		$(_closesel).on('click', function(){
			_this.destroy()
		});
    };
    //渲染
    Popover.prototype.render = function(){
        ...
        this.place();
		//console.log('Open!');
		if (typeof _this.opts.afterOpen == 'function') {
            _this.opts.afterOpen.call(this);
        }
		this.close();
    };
    //放置
    ...
    Popover.prototype.destroy = function(){
        ...
        _this.timer_out = window.setTimeout(function () {
			...
			if (typeof _this.opts.beforeClose == 'function') {
				_this.opts.beforeClose.call(this);
			}
            $('.popover').parent('div').remove();
